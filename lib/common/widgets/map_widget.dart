...
class _MapWidgetState extends State<MapWidget> {
  ...
  void initState() {
    ...
    _latLng = LatLng(double.tryParse(widget.address!.latitude!) ?? 0.0, double.tryParse(widget.address!.longitude!) ?? 0.0);
    _setMarker();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: (ResponsiveHelper.isDesktop(context) ? const PreferredSize(preferredSize: Size.fromHeight(100), child: WebAppBarWidget()) : CustomAppBarWidget(context: context, title: getTranslated('delivery_address', context))) as PreferredSizeWidget?,
                            ...
                            Row(children: [
                              ...
                              Expanded(
                                child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                                  ...
                                  Text(widget.address!.address!, style: rubikSemiBold),

                                ]),
                              ),
                            ]),

                            Text('- ${widget.address!.contactPersonName}', style: rubikSemiBold.copyWith(
