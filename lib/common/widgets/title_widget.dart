      ...
      if(onTap != null && !isShowTrailingIcon) InkWell(
        ...
        child: Padding(
          ...
          child: Text(
            ...
            style: subTitleTextStyle ?? rubikRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: themeProvider.darkTheme ? null : ColorResources.homePageSectionTitleColor),
          ),
        ),
      ),
    ]);
