...
class DateConverterHelper {
  ...
  static DateTime calculateExpireDate({
    ...
    switch (validityType.toLowerCase()) {
      case 'day':
        return createdDate.add(Duration(days: validity));
      case 'week':
        return createdDate.add(Duration(days: 7 * validity));
      case 'month':
        return DateTime(
          createdDate.year,
          createdDate.month + validity,
          createdDate.day,
          createdDate.hour,
          createdDate.minute,
          createdDate.second,
      ...
      default:
        throw ArgumentError('Invalid validity type: $validityType');
    }
  }
