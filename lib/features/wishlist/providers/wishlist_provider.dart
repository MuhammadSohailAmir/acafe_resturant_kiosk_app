...
class WishListProvider extends ChangeNotifier {
  ...
  void addToWishList(Product product, Function callBack) async {
    ...
    if (apiResponse.response != null && apiResponse.response!.statusCode == 200) {
      ...
      showCustomSnackBarHelper(getTranslated('added_to_your_favorites', Get.context!),isError: false);
    } else {
  ...
  void removeFromWishList(Product product, Function callBack) async {
    ...
    if (apiResponse.response != null && apiResponse.response!.statusCode == 200) {
      callBack();
      showCustomSnackBarHelper(getTranslated('removed_from_your_favorites', Get.context!), isError: false, snackBarStatus: SnackBarStatus.info);
