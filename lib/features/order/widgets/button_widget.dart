...
import 'package:acafe_customer/features/order/widgets/order_cancel_dialog_widget.dart';
        ...
        return Column(children: [
          !orderProvider.showCancelled ? Center(
            child: Container(
              ...
              child: Row(children: [
                orderProvider.trackModel?.orderStatus == 'new' ? Expanded(child: Padding(
          ...
          orderProvider.trackModel?.orderStatus == 'item_to_collect' && !(orderProvider.trackModel?.isGuest ?? false) &&  orderProvider.trackModel?.orderType != 'pos' && isPhoneNotAvailable ? Center(
            child: Container(
              width: width > 700 ? 700 : width,
          ...
          if(!(orderProvider.trackModel?.isGuest ?? false)
              ...
              && (orderProvider.trackModel?.orderStatus == 'item_to_collect'
