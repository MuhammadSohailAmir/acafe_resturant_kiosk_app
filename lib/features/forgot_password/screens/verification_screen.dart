...
import 'package:acafe_customer/features/auth/domain/models/user_log_data.dart';
import 'package:acafe_customer/features/auth/widgets/existing_account_bottom_sheet.dart';
...
class _VerificationScreenState extends State<VerificationScreen> {
  ...
  void initState() {
    ...
    // authProvider.verificationOtpTextController = TextEditingController();
                ...
                builder: (context, authProvider, child) => Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
                  ...
                  Padding(
                    ...
                    child: PinCodeTextField(
                      ...
                      // controller: authProvider.verificationOtpTextController,
                          ...
                          if(isPhone && isFirebaseOTP){
                            ...
                            authProvider.verifyPhoneForOtp(userInput).then((value){
                              ...
                              if((responseModel != null && responseModel.isSuccess) && tempToken == null) {
                                ...
                                if(responseModel.message == 'user' && context.mounted){
                            ...
                            if (widget.fromPage != FromPage.forget.name) {
                             ...
                             final bool isNumber = NumberCheckerHelper.isNumber(userInput);
                              ...
                              await authProvider.forgetPassword(
                                ...
                                authProvider.startVerifyTimer();
                                final isFirebaseVerification = isPhone && config.customerVerification?.firebase == 1 && config.customerVerification?.phone == 1;

                                if(!isFirebaseVerification) {
                                  if ((value?.isSuccess ?? false) && context.mounted) {
