...
import 'package:acafe_customer/features/category/widgets/qr_product_widget.dart';
...
class _BranchCategoryScreenState extends State<BranchCategoryScreen> with SingleTickerProviderStateMixin{
  ...
  @override
  void initState() {
    tabController = TabController(vsync: this, length: 1); // Veg/Non-Veg tabs hidden (café — was length: 3)
    ...
    tabController?.addListener(() {
      if(!tabController!.indexIsChanging){
        type = 'all'; // Veg/Non-Veg filter hidden (café — not relevant)
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      length: 1, // Veg/Non-Veg tabs hidden (café — was length: 3)
      child: Scaffold(
            ...
            return NestedScrollView(headerSliverBuilder: (BuildContext context, bool innerBoxIsScrolled) => [
              ...
              SliverToBoxAdapter(child: Center(child: TabBar(
                ...
                tabs: [
                  ...
                  // Veg / Non-Veg tabs hidden (café — not relevant)
                  // Tab(child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
