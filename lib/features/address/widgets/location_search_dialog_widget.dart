...
import 'package:acafe_customer/features/address/widgets/search_item_widget.dart';
...
class LocationSearchDialogWidget extends StatelessWidget {
  ...
  const LocationSearchDialogWidget({super.key, required this.mapController, this.margin});
