...
class _CreateAccountScreenState extends State<CreateAccountScreen> {
  ...
  void initState() {
    super.initState();
    _countryDialCode = CountryConfig.defaultCountryCode;
  }
                        ...
                        children: [
                          ...
                          Row(children: [
                            CodePickerWidget(
                              ...
                              initialSelection: CountryConfig.defaultCountryCode,
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text(
                                    ...
                                    style: Theme.of(context).textTheme.displayMedium!.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).hintColor.withValues(alpha:0.7)),
                                  ),
