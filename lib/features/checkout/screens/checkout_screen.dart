...
import 'package:acafe_customer/features/checkout/domain/models/check_out_model.dart';
import 'package:acafe_customer/features/checkout/providers/checkout_provider.dart';
import 'package:acafe_customer/features/checkout/widgets/confirm_button_widget.dart';
import 'package:acafe_customer/features/checkout/widgets/cost_summery_widget.dart';
import 'package:acafe_customer/features/checkout/widgets/payment_details_widget.dart';
import 'package:acafe_customer/features/checkout/widgets/slot_widget.dart';
import 'package:acafe_customer/features/checkout/widgets/upside_expansion_widget.dart';
...
class _CheckoutScreenState extends State<CheckoutScreen> {
                ...
                Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Expanded(flex: 6, child: Container(
                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      PaymentDetailsWidget(total: widget.amount ?? 0),
  ...
  Future<void> _onInitLoad() async {
    ...
    if(splashProvider.configModel!.cashOnDelivery!) {
      ...
      _paymentColor.add( Colors.primaries[Random().nextInt(Colors.primaries.length)].withValues(alpha:0.02));
    }
    ...
    if(splashProvider.configModel?.walletStatus ?? false) {
      ...
      _paymentColor.add( Colors.primaries[Random().nextInt(Colors.primaries.length)].withValues(alpha:0.1));
    }
    ...
    if(_isLoggedIn || (splashProvider.configModel?.isGuestCheckout ?? false)) {
      ...
      CheckOutHelper.selectPaymentMethodAutomatically(
        activePaymentMethodList: splashProvider.configModel?.activePaymentMethodList ?? [],
        isCashOnDeliveryActive: splashProvider.configModel?.cashOnDelivery ?? false,
      );
    }
  }
