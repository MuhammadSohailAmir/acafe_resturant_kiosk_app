...
import 'package:acafe_customer/features/checkout/widgets/bring_change_input_widget.dart';
...
import 'package:acafe_customer/features/checkout/widgets/offline_payment_widget.dart';
import 'package:acafe_customer/features/checkout/widgets/payment_button_widget.dart';
import 'package:acafe_customer/features/wallet/widgets/add_fund_dialogue_widget.dart';
                    ...
                    Padding(
                      ...
                      child: CustomButtonWidget(
                        ...
                        onTap: _paymentMethodIndex == null
                            ...
                            ? null : () {
                          if((_paymentMethod?.type == 'offline' || (_paymentMethod?.isOffline ?? false)) && _selectedOfflineValue == null){
